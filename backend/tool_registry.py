...
from tools.schemas import (
    ...
    TrackLcBankGuaranteeInput,
    TrackLcBankGuaranteeOutput,
...
from tools.schemas import (
    ...
    GenerateCashFlowStatementOutput,
...
REGISTRY: dict[str, ToolEntry] = {
    ...
    "track_lc_bank_guarantee": (track_lc_bank_guarantee, TrackLcBankGuaranteeInput, TrackLcBankGuaranteeOutput, False),
    ...
    "get_ap_aging_report": (get_ap_aging_report, GetAPAgingInput, GetAPAgingOutput, False),
    "get_ar_aging_report": (get_ar_aging_report, GetARAgingInput, GetARAgingOutput, False),
    ...
    "generate_cash_flow_statement": (generate_cash_flow_statement, GenerateCashFlowStatementInput, GenerateCashFlowStatementOutput, False),
